CREATE TABLE tb_discuss_comment (
	...
	recipient_feedbackapp_response_id bigint NOT NULL,
	sender_id bigint NOT NULL,
	comment_text varchar(1000),
	PRIMARY KEY (pk_discuss_comment_id),
	FOREIGN KEY (recipient_feedbackapp_response_id) REFERENCES tb_feedbackapp_response (pk_feedbackapp_response_id),
